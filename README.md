...
- **Modern Tech Stack**: Built on the latest Astro 5 framework for blazing fast performance.
- **Sage Green Aesthetic**: A custom-designed minimal interface with a professional color palette.
- **Intelligent AI Assistant**: LocalAI chatbot that answers 400+ questions about Wisnu's background, skills, and projects in both Indonesian and English.
- **Hybrid Architecture**:
  - **Landing Page**: A rich, scrolling home page (`/`) showcasing all sections.
...
- **AI Assistant**: Custom LocalAI implementation in TypeScript
...
The LocalAI assistant can answer questions about:
